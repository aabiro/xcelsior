/** Complete list of E.164 country calling codes with flag emoji and name. */
export const COUNTRY_CODES: { code: string; flag: string; name: string }[] = [
    ...
    { code: "+508", flag: "🇵🇲", name: "Saint Pierre & Miquelon" },
    { code: "+1784", flag: "🇻🇨", name: "Saint Vincent & the Grenadines" },
    ...
    { code: "+1649", flag: "🇹🇨", name: "Turks & Caicos Islands" },
    ...
    { code: "+681", flag: "🇼🇫", name: "Wallis & Futuna" },
