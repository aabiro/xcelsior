...
> = {
  ...
  "gpu:read": { labelKey: "dash.settings.oauth.scope_gpu_read", tone: "emerald" },
  "marketplace:read": { labelKey: "dash.settings.oauth.scope_marketplace_read", tone: "cyan" },
  "events:read": { labelKey: "dash.settings.oauth.scope_events_read", tone: "violet" },
