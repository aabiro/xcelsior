...
function TemplateLogoSVG({ template, size = 64 }: { template: TemplateKey; size?: number }) {
  ...
  switch (template) {
    ...
    case 'jupyter':
      // Official Jupyter logo from /logos/jupyter.svg (top arc, bottom arc, 3 dots)
      return (
        <svg width={size} height={size} viewBox="-22 0 300 300" xmlns="http://www.w3.org/2000/svg">
          {/* Bottom arc */}
          <path d="M127.952969,225.5 C80.0236372,225.5 37.9,208.3 16.1,182.9 C24.5683135,205.8 39.8,225.5 59.8,239.4 C79.8070981,253.4 103.6,260.8 128,260.8 C152.318411,260.8 176.1,253.4 196.1,239.4 C216.0886,225.5 231.3,205.8 239.8,182.9 C218.061379,208.3 176.1,225.5 128,225.5 Z" fill="#F37726" />
          {/* Top arc */}
          ...
          {/* Top-right gray dot */}
          <path d="M233.257943,17 C233.476636,20.5 232.6,24.1 230.8,27.2 C228.999898,30.3 226.3,32.8 223.1,34.3 C219.85034,35.9 216.2,36.4 212.7,35.9 C209.134702,35.4 205.8,33.9 203.2,31.5 C200.491421,29.1 198.6,25.9 197.7,22.5 C196.855323,19 197,15.3 198.2,12 C199.461041,8.6 201.7,5.6 204.5,3.5 C207.423803,1.4 210.9,0.2 214.5,0 C216.806708,-0.1 219.2,0.2 221.4,1 C223.591922,1.8 225.6,3 227.4,4.6 C229.12701,6.2 230.5,8.1 231.6,10.2 C232.563283,12.3 233.1,14.6 233.3,17 Z" fill="#767677" />
          {/* Bottom-left gray dot */}
          <path d="M61.9716874,275 C62.2528294,279.5 61.2,284 58.9,287.9 C56.6284936,291.8 53.2,294.9 49.2,296.9 C45.1113611,298.8 40.6,299.5 36.1,298.9 C31.6125362,298.3 27.4,296.3 24.1,293.3 C20.7160636,290.3 18.3,286.3 17.2,282 C16.1223339,277.6 16.3,273 17.9,268.7 C19.3913284,264.5 22.1,260.8 25.8,258.1 C29.4129289,255.4 33.8,253.9 38.3,253.7 C41.2280121,253.5 44.2,253.9 47,254.9 C49.7659364,255.9 52.3,257.4 54.5,259.4 C56.7364042,261.4 58.5,263.8 59.8,266.5 C61.0776558,269.1 61.8,272 62,275 Z" fill="#9E9E9E" />
          {/* Small top-left dark dot */}
          <path d="M21.5641016,54.6 C18.9814831,54.6 16.4,53.9 14.2,52.6 C12.0567996,51.2 10.3,49.2 9.3,46.9 C8.19768984,44.5 7.9,41.9 8.3,39.3 C8.69771827,36.8 9.9,34.4 11.6,32.5 C13.3892752,30.6 15.7,29.3 18.2,28.7 C20.6997394,28.1 23.3,28.3 25.8,29.2 C28.1787154,30.1 30.3,31.7 31.8,33.8 C33.3191879,35.9 34.2,38.4 34.3,40.9 C34.3930308,44.4 33.1,47.8 30.7,50.4 C28.3470417,52.9 25.1,54.4 21.6,54.6 Z" fill="#616262" />
        </svg>
      );
    case 'comfyui':
