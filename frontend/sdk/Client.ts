...
import { CloudBurstClient } from "./api/resources/cloudBurst/client/Client.js";
...
import { SlurmClient } from "./api/resources/slurm/client/Client.js";
...
export class XcelsiorApiClient {
    ...
    protected _cloudBurst: CloudBurstClient | undefined;
    ...
    protected _slurm: SlurmClient | undefined;
    ...
    public get cloudBurst(): CloudBurstClient {
        return (this._cloudBurst ??= new CloudBurstClient(this._options));
    }
    ...
    public get slurm(): SlurmClient {
        return (this._slurm ??= new SlurmClient(this._options));
    }
