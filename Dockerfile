...
# Install system deps for psycopg (libpq) and SSH (scheduler needs ssh client)
RUN apt-get update && apt-get install -y --no-install-recommends libpq5 openssh-client && rm -rf /var/lib/apt/lists/*
