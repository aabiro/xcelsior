...
class TestBinPackScheduler:
    ...
    def test_binpack_prefers_tighter_fit(self):
        ...
        hosts = [
            {"host_id": "big", "free_vram_gb": 80, "total_vram_gb": 80, "gpu_count": 1,
             "admitted": True, "gpu_model": "A100", "cost_per_hour": 2.0},
            {"host_id": "small", "free_vram_gb": 16, "total_vram_gb": 16, "gpu_count": 1,
             "admitted": True, "gpu_model": "RTX 4060", "cost_per_hour": 0.3},
        ]
    ...
    def test_binpack_multi_gpu_requires_single_host(self):
        ...
        from scheduler import allocate_binpack
        hosts = [
            {"host_id": "single", "free_vram_gb": 48, "total_vram_gb": 48, "gpu_count": 1,
             "admitted": True, "gpu_model": "A100"},
            {"host_id": "multi", "free_vram_gb": 160, "total_vram_gb": 160, "gpu_count": 4,
             "admitted": True, "gpu_model": "A100"},
        ]
    ...
    def test_binpack_no_fit_returns_none(self):
        ...
        from scheduler import allocate_binpack
        hosts = [
            {"host_id": "tiny", "free_vram_gb": 4, "total_vram_gb": 8, "gpu_count": 1,
             "admitted": True, "gpu_model": "RTX 3060"},
        ]
    ...
    def test_binpack_locality_bonus(self):
        ...
        from scheduler import allocate_binpack
        hosts = [
            {"host_id": "remote", "free_vram_gb": 16, "total_vram_gb": 16, "gpu_count": 1,
             "admitted": True, "gpu_model": "RTX 4090", "cost_per_hour": 0.5,
             "province": "BC", "country": "CA"},
            {"host_id": "local", "free_vram_gb": 16, "total_vram_gb": 16, "gpu_count": 1,
             "admitted": True, "gpu_model": "RTX 4090", "cost_per_hour": 0.5,
