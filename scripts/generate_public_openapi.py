...
CLIENT_OPERATION_ALLOWLIST = {
    ...
    ("/api/inference", "post"),
    ("/api/inference/{job_id}", "get"),
    ("/api/inference/models/available", "get"),
    ("/v1/inference", "post"),
    ("/v1/inference/async", "post"),
    ("/v1/inference/{job_id}", "get"),
    ("/api/v2/serverless/enabled", "get"),
    ("/api/v2/serverless/endpoints", "get"),
    ("/api/v2/serverless/endpoints", "post"),
    ("/api/v2/serverless/endpoints/{endpoint_id}", "get"),
    ("/api/v2/serverless/endpoints/{endpoint_id}", "patch"),
    ("/api/v2/serverless/endpoints/{endpoint_id}", "delete"),
    ("/api/v2/serverless/endpoints/{endpoint_id}/health", "get"),
    ("/api/v2/serverless/endpoints/{endpoint_id}/usage", "get"),
    ("/api/v2/serverless/endpoints/{endpoint_id}/keys", "get"),
    ("/api/v2/serverless/endpoints/{endpoint_id}/keys", "post"),
    ("/api/v2/serverless/endpoints/{endpoint_id}/keys/{key_id}", "delete"),
    ("/v1/serverless/{endpoint_id}/run", "post"),
    ("/v1/serverless/{endpoint_id}/runsync", "post"),
    ("/v1/serverless/{endpoint_id}/status/{job_id}", "get"),
    ("/v1/serverless/{endpoint_id}/stream/{job_id}", "get"),
    ("/v1/serverless/{endpoint_id}/cancel/{job_id}", "post"),
    ("/v1/serverless/{endpoint_id}/openai/v1/chat/completions", "post"),
    ("/v1/serverless/{endpoint_id}/openai/v1/models", "get"),
