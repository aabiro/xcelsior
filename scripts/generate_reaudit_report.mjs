...
const REMEDIATION = [
  ...
  { id: "F-004", sev: "P1", commit: "eb338b2", files: "ObfuscationSafeMailto, legal i18n", fix: "CF email obfuscation hydration; post-mount mailto" },
  ...
  { id: "F-014", sev: "P2", commit: "181ad74", files: "marketing CSS", fix: "Contrast: Beta, sovereignty badge, support CTA" },
  { id: "F-015", sev: "P2", commit: "181ad74", files: "landing H1", fix: "H1 spacing (hero_line1 trailing space)" },
  { id: "F-016", sev: "P2", commit: "5fc95d3", files: "register", fix: "Terms required + a11y errors" },
  { id: "F-017", sev: "P2", commit: "181ad74", files: "privacy page", fix: "Third-party disclosure (GTM, Cloudflare)" },
  { id: "F-018", sev: "P3", commit: "181ad74", files: "JSON-LD", fix: "Organization @id; blog publisher reference" },
  { id: "F-019", sev: "P3", commit: "b87c8f1", files: "layout.tsx", fix: "GTM lazyOnload, no preload" },
  { id: "F-020", sev: "P3", commit: "181ad74", files: "install banner", fix: "Route allowlist for PWA install prompt" },
  { id: "F-021", sev: "P3", commit: "181ad74", files: "blog metadata", fix: "Stable UTC dates in sitemap, RSS, OG" },
